...
local ht=Instance.new("TextLabel",hdr)ht.Size=UDim2.new(1,-60,1,0)ht.Position=UDim2.new(0,12,0,0)ht.BackgroundTransparency=1 ht.Text="DAMIR HUB v9.2"ht.TextColor3=C.w ht.Font=Enum.Font.GothamBold ht.TextSize=13
...
local function ul()
 ...
 tt.Text=L.th..th[ti].name lb2.Text=L.lb lgt.Text=L.news
end
...
-- FARM
local ft=Instance.new("TextLabel",fpg)ft.Size=UDim2.new(1,0,0,18)ft.BackgroundTransparency=1 ft.Text="MOLOT v9.2"ft.TextColor3=C.w ft.Font=Enum.Font.GothamBold ft.TextSize=12
...
local tt=Instance.new("TextLabel",spg)tt.Size=UDim2.new(1,0,0,16)tt.Position=UDim2.new(0,0,0,40)tt.BackgroundTransparency=1 tt.Text="Theme: Standard"tt.TextColor3=C.w tt.Font=Enum.Font.GothamBold tt.TextSize=11
...
trBtn.MouseButton1Click:Connect(function()ti2=ti2%#to+1 tv=to[ti2]m.BackgroundTransparency=tv s.BackgroundTransparency=tv hdr.BackgroundTransparency=tv mini.BackgroundTransparency=tv trBtn.Text=tn[ti2]tl.Text="Transparency: "..tn[ti2]ss(lang,ti,ti2)end)
...
ul()
game.StarterGui:SetCore("SendNotification",{Title="DAMIR HUB",Text="v9.2 loaded!",Duration=3})
