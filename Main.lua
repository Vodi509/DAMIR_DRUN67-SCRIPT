...
local lang="EN"
local T={EN={farm="FARM",set="SETTINGS",news="NEWS",h="START HAMMER",ho="HAMMER ACTIVE",a="AUTO FARM",ao="AUTO ACTIVE",car="Looking for car...",sit="Sit in a car!",resp="Respawning...",des="Destroyed!",th="Theme: ",lb="EN->RU",
secret="You found the secret button! 🎉\n\nThis script was made with love and pain by Damir.\nRemember: nothing is impossible if you have desire and perseverance.\n\nGood luck with your crush farming! 💪\n\n     /\\_/\\\n    ( o.o )\n     > ^ <\n    Meow! 🐱"},
RU={farm="ФАРМ",set="НАСТРОЙКИ",news="НОВОЕ",h="МОЛОТ",ho="МОЛОТ ON",a="АВТО-ФАРМ",ao="АВТО ON",car="Ищу машину...",sit="Сядьте!",resp="Респавн...",des="Убита!",th="Тема: ",lb="RU->EN",
secret="Ты нашёл секретную кнопку! 🎉\n\nЭтот скрипт сделан с любовью и болью Дамиром.\nПомни: нет ничего невозможного, если есть желание и упорство.\n\nУдачи в фарме! 💪\n\n     /\\_/\\\n    ( o.o )\n     > ^ <\n    Мяу! 🐱"}}
...
lgc.Text=[[v9.9 - Secret Page Translation:
+ Secret page now translates
...
ul()
game.StarterGui:SetCore("SendNotification",{Title="DAMIR HUB",Text="v9.9 loaded! Tap logo 3x",Duration=5})
