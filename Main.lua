...
local ti=1
local lang="EN"
local T={EN={farm="FARM",set="SETTINGS",news="NEWS",h="START HAMMER",ho="HAMMER ACTIVE",a="AUTO FARM",ao="AUTO ACTIVE",car="Looking for car...",sit="Sit in a car!",resp="Respawning...",des="Destroyed!",th="Theme: ",thb="CHANGE",lb="EN->RU",cl="WHATS NEW"},RU={farm="FARM",set="SETTINGS",news="NEWS",h="MOLOT",ho="MOLOT ON",a="AUTO FARM",ao="AUTO ON",car="Ищу машину...",sit="Сядьте!",resp="Респавн...",des="Убита!",th="Тема: ",thb="СМЕНИТЬ",lb="RU->EN",cl="НОВОЕ"}}
...
mini.BackgroundColor3=th[1].s mini.BorderSizePixel=0 mini.Visible=false mini.Active=true mini.Draggable=true
Instance.new("UICorner",mini).CornerRadius=UDim.new(0,6)
local rBtn=Instance.new("TextButton",mini) rBtn.Size=UDim2.new(1,0,1,0) rBtn.BackgroundTransparency=1 rBtn.Text="DAMIR HUB" rBtn.TextColor3=C.r rBtn.Font=Enum.Font.GothamBold rBtn.TextSize=12

local m=Instance.new("Frame",sg) m.Size=UDim2.new(0,500,0,310) m.Position=UDim2.new(0.5,-250,0.5,-155)
m.BackgroundColor3=th[1].m m.BorderSizePixel=0 m.Active=true m.Draggable=true
...
ht.Text="DAMIR HUB v8.5" ht.TextColor3=C.w ht.Font=Enum.Font.GothamBold ht.TextSize=13 ht.TextXAlignment=Enum.TextXAlignment.Left
...
clB.BackgroundColor3=C.r clB.Text="X" clB.TextColor3=C.w clB.Font=Enum.Font.GothamBold clB.TextSize=12 clB.BorderSizePixel=0
...
local lb2=Instance.new("TextLabel",s) lb2.Size=UDim2.new(1,0,0,40) lb2.BackgroundTransparency=1 lb2.Text="DAMIR HUB" lb2.TextColor3=C.r lb2.Font=Enum.Font.GothamBold lb2.TextSize=14
...
local function ul()
    ...
    hi.Text=(lang=="EN") and "If broken - rejoin" or "Если сломался - перезайди"
    tt.Text=L.th..th[ti].name tb.Text=L.thb lgt.Text=L.cl lb.Text=L.lb
end

-- FARM
local ft=Instance.new("TextLabel",fpg) ft.Size=UDim2.new(1,0,0,18) ft.BackgroundTransparency=1 ft.Text="MOLOT v8.5" ft.TextColor3=C.w ft.Font=Enum.Font.GothamBold ft.TextSize=12 ft.TextXAlignment=Enum.TextXAlignment.Left
...
spawn(function() while wait(0.3) do pcall(function() local c=gc() if c then cl.Text=c.Name cl.TextColor3=C.b else cl.Text=T[lang].sit cl.TextColor3=C.r end end) end end)
...
local hi=Instance.new("TextLabel",fpg) hi.Size=UDim2.new(1,0,0,14) hi.Position=UDim2.new(0,0,0,162) hi.BackgroundTransparency=1 hi.Text="If broken - rejoin" hi.TextColor3=Color3.fromRGB(255,180,50) hi.Font=Enum.Font.Gotham hi.TextSize=9 hi.TextXAlignment=Enum.TextXAlignment.Center

hb.MouseButton1Click:Connect(function()
    ho=not ho
    if ho then if ao then ao=false ab.Text=T[lang].a ab.TextColor3=C.g ab.BackgroundColor3=C.btn end hb.Text=T[lang].ho hb.TextColor3=C.gr hb.BackgroundColor3=Color3.fromRGB(18,38,24)
...
ab.MouseButton1Click:Connect(function()
    ...
    if ao then if ho then ho=false hb.Text=T[lang].h hb.TextColor3=C.r hb.BackgroundColor3=C.btn end ab.Text=T[lang].ao ab.TextColor3=C.gr ab.BackgroundColor3=Color3.fromRGB(40,25,10)
        coroutine.wrap(function()
            while ao do local c=gc() if not c then cl.Text=T[lang].resp wait(3)
                ...
                if d then cy=cy+1 sl.Text="Hits: "..hh.." | Broken: "..br.." | Auto: "..cy cl.Text=T[lang].des wait(1) cl.Text=T[lang].resp wait(3) end end
            end
        end)()
    else ab.Text=T[lang].a ab.TextColor3=C.g ab.BackgroundColor3=C.btn end
end)
...
tb.Text="CHANGE" tb.TextColor3=C.g
...
ul()
game.StarterGui:SetCore("SendNotification",{Title="DAMIR HUB",Text="v8.5 loaded!",Duration=3})
