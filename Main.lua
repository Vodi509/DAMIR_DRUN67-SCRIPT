...
local lang="EN"
local T={EN={farm="FARM",set="SETTINGS",news="NEWS",h="START HAMMER",ho="HAMMER ACTIVE",a="AUTO FARM",ao="AUTO ACTIVE",car="Looking for car...",sit="Sit in a car!",resp="Respawning...",des="Destroyed!",th="Theme: ",lb="EN->RU",secret="You found the secret!\n\nMade with love by Damir.\n\nMeow! 🐱"},RU={farm="ФАРМ",set="НАСТРОЙКИ",news="НОВОЕ",h="МОЛОТ",ho="МОЛОТ ON",a="АВТО-ФАРМ",ao="АВТО ON",car="Ищу машину...",sit="Сядьте!",resp="Респавн...",des="Убита!",th="Тема: ",lb="RU->EN",secret="Ты нашёл секрет!\n\nСделано с любовью Дамиром.\n\nМяу! 🐱"}}
...
local ht=Instance.new("TextLabel",hdr)ht.Size=UDim2.new(1,-60,1,0)ht.Position=UDim2.new(0,12,0,0)ht.BackgroundTransparency=1 ht.Text="DAMIR HUB v9.11"ht.TextColor3=C.w ht.Font=Enum.Font.GothamBold ht.TextSize=13
...
-- FARM
local ft=Instance.new("TextLabel",fpg)ft.Size=UDim2.new(1,0,0,18)ft.BackgroundTransparency=1 ft.Text="MOLOT v9.11"ft.TextColor3=C.w ft.Font=Enum.Font.GothamBold ft.TextSize=12
...
local tl=Instance.new("TextLabel",spg)tl.Size=UDim2.new(1,0,0,16)tl.Position=UDim2.new(0,0,0,95)tl.BackgroundTransparency=1 tl.Text="Transparency: 45%"tl.TextColor3=C.w tl.Font=Enum.Font.GothamBold tl.TextSize=11
local trBtn=Instance.new("TextButton",spg)trBtn.Size=UDim2.new(1,0,0,26)trBtn.Position=UDim2.new(0,0,0,113)trBtn.BackgroundColor3=C.btn trBtn.Font=Enum.Font.GothamBold trBtn.TextSize=11 trBtn.BorderSizePixel=0 trBtn.Text="45%"trBtn.TextColor3=C.w
...
lgc.Text=[[v9.11 - Stable:
+ Fixed all buttons text
+ Theme change works
+ 45% default transparency
+ Secret button (tap logo 3x)
+ Molot 200/-1500
+ Auto farm + respawn]]

ul()
game.StarterGui:SetCore("SendNotification",{Title="DAMIR HUB",Text="v9.11 loaded!",Duration=3})
