...
local ht=Instance.new("TextLabel",hdr)ht.Size=UDim2.new(1,-60,1,0)ht.Position=UDim2.new(0,12,0,0)ht.BackgroundTransparency=1 ht.Text="DAMIR HUB v9.6"ht.TextColor3=C.w ht.Font=Enum.Font.GothamBold ht.TextSize=13
...
-- FARM
local ft=Instance.new("TextLabel",fpg)ft.Size=UDim2.new(1,0,0,18)ft.BackgroundTransparency=1 ft.Text="MOLOT v9.6"ft.TextColor3=C.w ft.Font=Enum.Font.GothamBold ft.TextSize=12
